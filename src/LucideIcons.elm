...
arrowBigDownIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M9 5a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v6a1 1 0 0 0 1 1h3.293a.707.707 0 0 1 .5 1.207l-7.086 7.086a1 1 0 0 1-1.414 0l-7.086-7.086a.707.707 0 0 1 .5-1.207H8a1 1 0 0 0 1-1z" ] [] ]
...
arrowBigDownDashIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M14 8a1 1 0 0 1 1 1v2a1 1 0 0 0 1 1h3.293a.707.707 0 0 1 .5 1.207l-6.939 6.939a1.207 1.207 0 0 1-1.708 0l-6.94-6.94a.707.707 0 0 1 .5-1.206H8a1 1 0 0 0 1-1V9a1 1 0 0 1 1-1z" ] [], S.path [ SA.d "M9 4h6" ] [] ]
...
arrowBigLeftIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M10.793 19.793a.707.707 0 0 0 1.207-.5V16a1 1 0 0 1 1-1h6a1 1 0 0 0 1-1v-4a1 1 0 0 0-1-1h-6a1 1 0 0 1-1-1V4.707a.707.707 0 0 0-1.207-.5l-6.94 6.94a1.207 1.207 0 0 0 0 1.707z" ] [] ]
...
arrowBigLeftDashIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M13 9a1 1 0 0 1-1-1V4.707a.707.707 0 0 0-1.207-.5l-6.94 6.94a1.207 1.207 0 0 0 0 1.707l6.94 6.94a.707.707 0 0 0 1.207-.5V16a1 1 0 0 1 1-1h2a1 1 0 0 0 1-1v-4a1 1 0 0 0-1-1z" ] [], S.path [ SA.d "M20 9v6" ] [] ]
...
arrowBigRightIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M13.207 19.793a.707.707 0 0 1-1.207-.5V16a1 1 0 0 0-1-1H5a1 1 0 0 1-1-1v-4a1 1 0 0 1 1-1h6a1 1 0 0 0 1-1V4.707a.707.707 0 0 1 1.207-.5l6.94 6.94a1.207 1.207 0 0 1 0 1.707z" ] [] ]
...
arrowBigRightDashIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M11 9a1 1 0 0 0 1-1V4.707a.707.707 0 0 1 1.207-.5l6.94 6.94a1.207 1.207 0 0 1 0 1.707l-6.94 6.94a.707.707 0 0 1-1.207-.5V16a1 1 0 0 0-1-1H9a1 1 0 0 1-1-1v-4a1 1 0 0 1 1-1z" ] [], S.path [ SA.d "M4 9v6" ] [] ]
...
arrowBigUpIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M9 19a1 1 0 0 0 1 1h4a1 1 0 0 0 1-1v-6a1 1 0 0 1 1-1h3.293a.707.707 0 0 0 .5-1.207l-7.086-7.086a1 1 0 0 0-1.414 0l-7.086 7.086a.707.707 0 0 0 .5 1.207H8a1 1 0 0 1 1 1z" ] [] ]
...
arrowBigUpDashIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M14 16a1 1 0 0 0 1-1v-2a1 1 0 0 1 1-1h3.293a.707.707 0 0 0 .5-1.207l-6.939-6.939a1.207 1.207 0 0 0-1.708 0l-6.94 6.94a.707.707 0 0 0 .5 1.206H8a1 1 0 0 1 1 1v2a1 1 0 0 0 1 1z" ] [], S.path [ SA.d "M9 20h6" ] [] ]
...
-}
astroidIcon : List (S.Attribute msg) -> H.Html msg
astroidIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M12.983 21.186a1 1 0 0 1-1.966 0 10 10 0 0 0-8.203-8.203 1 1 0 0 1 0-1.966 10 10 0 0 0 8.203-8.203 1 1 0 0 1 1.966 0 10 10 0 0 0 8.203 8.203 1 1 0 0 1 0 1.966 10 10 0 0 0-8.203 8.203" ] [] ]
...
-}
balloonIcon : List (S.Attribute msg) -> H.Html msg
balloonIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M12 16v1a2 2 0 0 0 2 2h1a2 2 0 0 1 2 2v1" ] [], S.path [ SA.d "M12 6a2 2 0 0 1 2 2" ] [], S.path [ SA.d "M18 8c0 4-3.5 8-6 8s-6-4-6-8a6 6 0 0 1 12 0" ] [] ]
...
-}
beefOffIcon : List (S.Attribute msg) -> H.Html msg
beefOffIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M11.771 6.109a2.5 2.5 0 0 1 3.12 3.12" ] [], S.path [ SA.d "M17.852 12.185a6.5 6.5 0 0 0-9.035-9.04" ] [], S.path [ SA.d "M18.013 18.013C15.029 20.349 10.831 22 7 22a3 3 0 0 1-2.68-1.66L2.4 16.5" ] [], S.path [ SA.d "m18.5 6 2.19 4.5a6.48 6.48 0 0 1-.139 4.393" ] [], S.path [ SA.d "m2 2 20 20" ] [], S.path [ SA.d "M6.355 6.37a7 7 0 0 0-.075.23c-1.1 3.13-.78 3.9-3.18 6.08A3 3 0 0 0 5 18c3.356 0 6.993-1.267 9.85-3.151" ] [] ]
...
-}
bellCheckIcon : List (S.Attribute msg) -> H.Html msg
bellCheckIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M10.268 21a2 2 0 0 0 3.464 0" ] [], S.path [ SA.d "m15 8 2 2 4-4" ] [], S.path [ SA.d "M16.8607 4.4824A6 6 0 0 0 6 8C6 12.499 4.589 13.956 3.262 15.326" ] [], S.path [ SA.d "M3.262 15.326A1 1 0 0 0 4 17H20A1 1 0 0 0 20.74 15.327C20.209 14.779 19.665 14.218 19.203 13.454" ] [] ]
...
-}
bookSearchIcon : List (S.Attribute msg) -> H.Html msg
bookSearchIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M11 22H5.5a1 1 0 0 1 0-5h4.501" ] [], S.path [ SA.d "m21 22-1.879-1.878" ] [], S.path [ SA.d "M3 19.5v-15A2.5 2.5 0 0 1 5.5 2H18a1 1 0 0 1 1 1v8" ] [], S.circle [ SA.cx "17", SA.cy "18", SA.r "3" ] [] ]
...
bookmarkIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M17 3a2 2 0 0 1 2 2v15a1 1 0 0 1-1.496.868l-4.512-2.578a2 2 0 0 0-1.984 0l-4.512 2.578A1 1 0 0 1 5 20V5a2 2 0 0 1 2-2z" ] [] ]
...
bookmarkCheckIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M17 3a2 2 0 0 1 2 2v15a1 1 0 0 1-1.496.868l-4.512-2.578a2 2 0 0 0-1.984 0l-4.512 2.578A1 1 0 0 1 5 20V5a2 2 0 0 1 2-2z" ] [], S.path [ SA.d "m9 10 2 2 4-4" ] [] ]
...
bookmarkMinusIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M15 10H9" ] [], S.path [ SA.d "M17 3a2 2 0 0 1 2 2v15a1 1 0 0 1-1.496.868l-4.512-2.578a2 2 0 0 0-1.984 0l-4.512 2.578A1 1 0 0 1 5 20V5a2 2 0 0 1 2-2z" ] [] ]
...
-}
bookmarkOffIcon : List (S.Attribute msg) -> H.Html msg
bookmarkOffIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M19 19v1a1 1 0 0 1-1.496.868l-4.512-2.578a2 2 0 0 0-1.984 0l-4.512 2.578A1 1 0 0 1 5 20V5" ] [], S.path [ SA.d "m2 2 20 20" ] [], S.path [ SA.d "M8.656 3H17a2 2 0 0 1 2 2v8.344" ] [] ]
...
bookmarkPlusIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M12 7v6" ] [], S.path [ SA.d "M15 10H9" ] [], S.path [ SA.d "M17 3a2 2 0 0 1 2 2v15a1 1 0 0 1-1.496.868l-4.512-2.578a2 2 0 0 0-1.984 0l-4.512 2.578A1 1 0 0 1 5 20V5a2 2 0 0 1 2-2z" ] [] ]
...
bookmarkXIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "m14.5 7.5-5 5" ] [], S.path [ SA.d "M17 3a2 2 0 0 1 2 2v15a1 1 0 0 1-1.496.868l-4.512-2.578a2 2 0 0 0-1.984 0l-4.512 2.578A1 1 0 0 1 5 20V5a2 2 0 0 1 2-2z" ] [], S.path [ SA.d "m9.5 7.5 5 5" ] [] ]
...
brushCleaningIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "m16 22-1-4" ] [], S.path [ SA.d "M19 14a1 1 0 0 0 1-1v-1a2 2 0 0 0-2-2h-3a1 1 0 0 1-1-1V4a2 2 0 0 0-4 0v5a1 1 0 0 1-1 1H6a2 2 0 0 0-2 2v1a1 1 0 0 0 1 1" ] [], S.path [ SA.d "M19 14H5l-1.973 6.767A1 1 0 0 0 4 22h16a1 1 0 0 0 .973-1.233z" ] [], S.path [ SA.d "m8 22 1-4" ] [] ]
...
bubblesIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M7.001 15.085A1.5 1.5 0 0 1 9 16.5" ] [], S.circle [ SA.cx "18.5", SA.cy "8.5", SA.r "3.5" ] [], S.circle [ SA.cx "7.5", SA.cy "16.5", SA.r "5.5" ] [], S.circle [ SA.cx "7.5", SA.cy "4.5", SA.r "2.5" ] [] ]
...
calendarsIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M12 2v2" ] [], S.path [ SA.d "M15.726 21.01A2 2 0 0 1 14 22H4a2 2 0 0 1-2-2V10a2 2 0 0 1 2-2" ] [], S.path [ SA.d "M18 2v2" ] [], S.path [ SA.d "M2 13h2" ] [], S.path [ SA.d "M8 8h14" ] [], S.rect [ SA.x "8", SA.y "3", SA.width "14", SA.height "14", SA.rx "2" ] [] ]
...
-}
cannabisOffIcon : List (S.Attribute msg) -> H.Html msg
cannabisOffIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M12 22v-4c1.5 1.5 3.5 3 6 3 0-1.5-.5-3.5-2-5" ] [], S.path [ SA.d "M13.988 8.327C13.902 6.054 13.365 3.82 12 2a9.3 9.3 0 0 0-1.445 2.9" ] [], S.path [ SA.d "M17.375 11.725C18.882 10.53 21 7.841 21 6c-2.324 0-5.08 1.296-6.662 2.684" ] [], S.path [ SA.d "m2 2 20 20" ] [], S.path [ SA.d "M21.024 15.378A15 15 0 0 0 22 15c-.426-1.279-2.67-2.557-4.25-2.907" ] [], S.path [ SA.d "M6.995 6.992C5.714 6.4 4.29 6 3 6c0 2 2.5 5 4 6-1.5 0-4.5 1.5-5 3 3.5 1.5 6 1 6 1-1.5 1.5-2 3.5-2 5 2.5 0 4.5-1.5 6-3" ] [] ]
...
-}
cctvOffIcon : List (S.Attribute msg) -> H.Html msg
cctvOffIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "m12.309 6.652 4.797 2.401a1 1 0 0 1 .447 1.341l-.501 1.001.605.605h2.725a1 1 0 0 1 .894 1.447l-.724 1.448" ] [], S.path [ SA.d "m15.166 15.166-.719 1.439a1 1 0 0 1-1.342.447L3.61 12.3a2.92 2.92 0 0 1-1.3-3.91L3.69 5.6a2.9 2.9 0 0 1 .873-1.037" ] [], S.path [ SA.d "M2 19h3.76a2 2 0 0 0 1.8-1.1l1.441-2.902" ] [], S.path [ SA.d "m2 2 20 20" ] [], S.path [ SA.d "M2 21v-4" ] [], S.path [ SA.d "M7 9h.01" ] [] ]
...
-}
circlePileIcon : List (S.Attribute msg) -> H.Html msg
circlePileIcon options =
    S.svg (baseOptions ++ options) [ S.circle [ SA.cx "12", SA.cy "19", SA.r "2" ] [], S.circle [ SA.cx "12", SA.cy "5", SA.r "2" ] [], S.circle [ SA.cx "16", SA.cy "12", SA.r "2" ] [], S.circle [ SA.cx "20", SA.cy "19", SA.r "2" ] [], S.circle [ SA.cx "4", SA.cy "19", SA.r "2" ] [], S.circle [ SA.cx "8", SA.cy "12", SA.r "2" ] [] ]
...
circleUserRoundIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M17.925 20.056a6 6 0 0 0-11.851.001" ] [], S.circle [ SA.cx "12", SA.cy "11", SA.r "4" ] [], S.circle [ SA.cx "12", SA.cy "12", SA.r "10" ] [] ]
...
-}
cloudBackupIcon : List (S.Attribute msg) -> H.Html msg
cloudBackupIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M21 15.251A4.5 4.5 0 0 0 17.5 8h-1.79A7 7 0 1 0 3 13.607" ] [], S.path [ SA.d "M7 11v4h4" ] [], S.path [ SA.d "M8 19a5 5 0 0 0 9-3 4.5 4.5 0 0 0-4.5-4.5 4.82 4.82 0 0 0-3.41 1.41L7 15" ] [] ]
...
cloudOffIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M10.94 5.274A7 7 0 0 1 15.71 10h1.79a4.5 4.5 0 0 1 4.222 6.057" ] [], S.path [ SA.d "M18.796 18.81A4.5 4.5 0 0 1 17.5 19H9A7 7 0 0 1 5.79 5.78" ] [], S.path [ SA.d "m2 2 20 20" ] [] ]
...
-}
cloudSyncIcon : List (S.Attribute msg) -> H.Html msg
cloudSyncIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "m17 18-1.535 1.605a5 5 0 0 1-8-1.5" ] [], S.path [ SA.d "M17 22v-4h-4" ] [], S.path [ SA.d "M20.996 15.251A4.5 4.5 0 0 0 17.495 8h-1.79a7 7 0 1 0-12.709 5.607" ] [], S.path [ SA.d "M7 10v4h4" ] [], S.path [ SA.d "m7 14 1.535-1.605a5 5 0 0 1 8 1.5" ] [] ]
...
cloudyIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M17.5 12a1 1 0 1 1 0 9H9.006a7 7 0 1 1 6.702-9z" ] [], S.path [ SA.d "M21.832 9A3 3 0 0 0 19 7h-2.207a5.5 5.5 0 0 0-10.72.61" ] [] ]
...
-}
fishingHookIcon : List (S.Attribute msg) -> H.Html msg
fishingHookIcon options =
...
flashlightIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M12 13v1" ] [], S.path [ SA.d "M17 2a1 1 0 0 1 1 1v4a3 3 0 0 1-.6 1.8l-.6.8A4 4 0 0 0 16 12v8a2 2 0 0 1-2 2H10a2 2 0 0 1-2-2v-8a4 4 0 0 0-.8-2.4l-.6-.8A3 3 0 0 1 6 7V3a1 1 0 0 1 1-1z" ] [], S.path [ SA.d "M6 6h12" ] [] ]
...
flashlightOffIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M11.652 6H18" ] [], S.path [ SA.d "M12 13v1" ] [], S.path [ SA.d "M16 16v4a2 2 0 0 1-2 2h-4a2 2 0 0 1-2-2v-8a4 4 0 0 0-.8-2.4l-.6-.8A3 3 0 0 1 6 7V6" ] [], S.path [ SA.d "m2 2 20 20" ] [], S.path [ SA.d "M7.649 2H17a1 1 0 0 1 1 1v4a3 3 0 0 1-.6 1.8l-.6.8a4 4 0 0 0-.55 1.007" ] [] ]
...
-}
folderBookmarkIcon : List (S.Attribute msg) -> H.Html msg
folderBookmarkIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M12 6v8l3-3 3 3V6" ] [], S.path [ SA.d "M20 20a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.9a2 2 0 0 1-1.69-.9L9.6 3.9A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2z" ] [] ]
...
-}
formIcon : List (S.Attribute msg) -> H.Html msg
formIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M4 14h6" ] [], S.path [ SA.d "M4 2h10" ] [], S.rect [ SA.x "4", SA.y "18", SA.width "16", SA.height "4", SA.rx "1" ] [], S.rect [ SA.x "4", SA.y "6", SA.width "16", SA.height "4", SA.rx "1" ] [] ]
...
-}
globeXIcon : List (S.Attribute msg) -> H.Html msg
globeXIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "m16 3 5 5" ] [], S.path [ SA.d "M2 12h20A10 10 0 1 1 12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 4-10" ] [], S.path [ SA.d "m21 3-5 5" ] [] ]
...
gpuIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M2 17h18a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2H2" ] [], S.path [ SA.d "M2 21V3" ] [], S.path [ SA.d "M7 17v3a1 1 0 0 0 1 1h5a1 1 0 0 0 1-1v-3" ] [], S.circle [ SA.cx "16", SA.cy "11", SA.r "2" ] [], S.circle [ SA.cx "8", SA.cy "11", SA.r "2" ] [] ]
...
-}
hdIcon : List (S.Attribute msg) -> H.Html msg
hdIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M10 12H6" ] [], S.path [ SA.d "M10 15V9" ] [], S.path [ SA.d "M14 14.5a.5.5 0 0 0 .5.5h1a2.5 2.5 0 0 0 2.5-2.5v-1A2.5 2.5 0 0 0 15.5 9h-1a.5.5 0 0 0-.5.5z" ] [], S.path [ SA.d "M6 15V9" ] [], S.rect [ SA.x "2", SA.y "5", SA.width "20", SA.height "14", SA.rx "2" ] [] ]
...
-}
heartXIcon : List (S.Attribute msg) -> H.Html msg
heartXIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "m15.5 12.5 5 5" ] [], S.path [ SA.d "m20.5 12.5-5 5" ] [], S.path [ SA.d "M21.955 8.774a5.5 5.5 0 0 0-9.546-2.95.6.6 0 0 1-.818 0A5.5 5.5 0 0 0 2 9.5c0 2.3 1.5 4 3 5.5l5.508 5.332a2 2 0 0 0 2.57.352" ] [] ]
...
lassoIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M3.704 14.467a10 8 0 1 1 3.115 2.375" ] [], S.path [ SA.d "M7 22a5 5 0 0 1-2-3.994" ] [], S.circle [ SA.cx "5", SA.cy "16", SA.r "2" ] [] ]
...
-}
layersMinusIcon : List (S.Attribute msg) -> H.Html msg
layersMinusIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M12.83 2.18a2 2 0 0 0-1.66 0L2.6 6.08a1 1 0 0 0 0 1.83l8.58 3.91a2 2 0 0 0 .83.18 2 2 0 0 0 .83-.18l8.58-3.9a1 1 0 0 0 0-1.832z" ] [], S.path [ SA.d "M16 17h6" ] [], S.path [ SA.d "M2.003 11.995a1 1 0 0 0 .597.915l8.58 3.91a2 2 0 0 0 .83.18" ] [], S.path [ SA.d "M2.003 16.995a1 1 0 0 0 .597.915l8.58 3.91a2 2 0 0 0 .83.18 2 2 0 0 0 .83-.18l2.11-.96" ] [], S.path [ SA.d "M22.018 12.004a1 1 0 0 1-.598.916l-.177.08" ] [] ]
...
-}
layersPlusIcon : List (S.Attribute msg) -> H.Html msg
layersPlusIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M12.83 2.18a2 2 0 0 0-1.66 0L2.6 6.08a1 1 0 0 0 0 1.83l8.58 3.91a2 2 0 0 0 .83.18 2 2 0 0 0 .83-.18l8.58-3.9a1 1 0 0 0 0-1.831z" ] [], S.path [ SA.d "M16 17h6" ] [], S.path [ SA.d "M19 14v6" ] [], S.path [ SA.d "M2 12a1 1 0 0 0 .58.91l8.6 3.91a2 2 0 0 0 .825.178" ] [], S.path [ SA.d "M2 17a1 1 0 0 0 .58.91l8.6 3.91a2 2 0 0 0 1.65 0l2.116-.962" ] [] ]
...
-}
lineStyleIcon : List (S.Attribute msg) -> H.Html msg
lineStyleIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M11 5h2" ] [], S.path [ SA.d "M15 12h6" ] [], S.path [ SA.d "M19 5h2" ] [], S.path [ SA.d "M3 12h6" ] [], S.path [ SA.d "M3 19h18" ] [], S.path [ SA.d "M3 5h2" ] [] ]
...
-}
mapPinSearchIcon : List (S.Attribute msg) -> H.Html msg
mapPinSearchIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M 12.248 21.969 a 1 1 0 0 1 -0.849 -0.17 C 9.539 20.193 4 14.993 4 10 a 8 8 0 0 1 16 0 C 20 10.42 19.961 10.841 19.888 11.262" ] [], S.path [ SA.d "m22 22-1.88-1.88" ] [], S.circle [ SA.cx "12", SA.cy "10", SA.r "3" ] [], S.circle [ SA.cx "18", SA.cy "18", SA.r "3" ] [] ]
...
memoryStickIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M12 12v-2" ] [], S.path [ SA.d "M12 18v-2" ] [], S.path [ SA.d "M16 12v-2" ] [], S.path [ SA.d "M16 18v-2" ] [], S.path [ SA.d "M2 11h1.5" ] [], S.path [ SA.d "M20 18v-2" ] [], S.path [ SA.d "M20.5 11H22" ] [], S.path [ SA.d "M4 18v-2" ] [], S.path [ SA.d "M8 12v-2" ] [], S.path [ SA.d "M8 18v-2" ] [], S.rect [ SA.x "2", SA.y "6", SA.width "20", SA.height "10", SA.rx "2" ] [] ]
...
messageSquareDashedIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M14 3h2" ] [], S.path [ SA.d "M16 19h-2" ] [], S.path [ SA.d "M2 12v-2" ] [], S.path [ SA.d "M2 16v5.286a.71.71 0 0 0 1.212.502l1.149-1.149" ] [], S.path [ SA.d "M20 19a2 2 0 0 0 2-2v-1" ] [], S.path [ SA.d "M22 10v2" ] [], S.path [ SA.d "M22 6V5a2 2 0 0 0-2-2" ] [], S.path [ SA.d "M4 3a2 2 0 0 0-2 2v1" ] [], S.path [ SA.d "M8 19h2" ] [], S.path [ SA.d "M8 3h2" ] [] ]
...
microchipIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M10 12h4" ] [], S.path [ SA.d "M10 17h4" ] [], S.path [ SA.d "M10 7h4" ] [], S.path [ SA.d "M18 12h2" ] [], S.path [ SA.d "M18 18h2" ] [], S.path [ SA.d "M18 6h2" ] [], S.path [ SA.d "M4 12h2" ] [], S.path [ SA.d "M4 18h2" ] [], S.path [ SA.d "M4 6h2" ] [], S.rect [ SA.x "6", SA.y "2", SA.width "12", SA.height "20", SA.rx "2" ] [] ]
...
milestoneIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M12 13v8" ] [], S.path [ SA.d "M12 3v3" ] [], S.path [ SA.d "M18.172 6a2 2 0 0 1 1.414.586l2.06 2.06a1.207 1.207 0 0 1 0 1.708l-2.06 2.06a2 2 0 0 1-1.414.586H4a1 1 0 0 1-1-1V7a1 1 0 0 1 1-1z" ] [] ]
...
monitorOffIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M12 17v4" ] [], S.path [ SA.d "M17 17H4a2 2 0 0 1-2-2V5a2 2 0 0 1 1.184-1.826" ] [], S.path [ SA.d "m2 2 20 20" ] [], S.path [ SA.d "M8 21h8" ] [], S.path [ SA.d "M8.656 3H20a2 2 0 0 1 2 2v10a2 2 0 0 1-.293 1.042" ] [] ]
...
paintBucketIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M11 7 6 2" ] [], S.path [ SA.d "M18.992 12H2.041" ] [], S.path [ SA.d "M21.145 18.38A3.34 3.34 0 0 1 20 16.5a3.3 3.3 0 0 1-1.145 1.88c-.575.46-.855 1.02-.855 1.595A2 2 0 0 0 20 22a2 2 0 0 0 2-2.025c0-.58-.285-1.13-.855-1.595" ] [], S.path [ SA.d "m8.5 4.5 2.148-2.148a1.205 1.205 0 0 1 1.704 0l7.296 7.296a1.205 1.205 0 0 1 0 1.704l-7.592 7.592a3.615 3.615 0 0 1-5.112 0l-3.888-3.888a3.615 3.615 0 0 1 0-5.112L5.67 7.33" ] [] ]
...
plugIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M12 22v-5" ] [], S.path [ SA.d "M15 8V2" ] [], S.path [ SA.d "M17 8a1 1 0 0 1 1 1v4a4 4 0 0 1-4 4h-4a4 4 0 0 1-4-4V9a1 1 0 0 1 1-1z" ] [], S.path [ SA.d "M9 8V2" ] [] ]
...
-}
printerXIcon : List (S.Attribute msg) -> H.Html msg
printerXIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M12.531 22H7a1 1 0 0 1-1-1v-6a1 1 0 0 1 1-1h6.377" ] [], S.path [ SA.d "m16.5 16.5 5 5" ] [], S.path [ SA.d "m16.5 21.5 5-5" ] [], S.path [ SA.d "M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v1.5" ] [], S.path [ SA.d "M6 9V3a1 1 0 0 1 1-1h10a1 1 0 0 1 1 1v6" ] [] ]
...
-}
radioOffIcon : List (S.Attribute msg) -> H.Html msg
radioOffIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M13.414 13.414a2 2 0 1 1-2.828-2.828" ] [], S.path [ SA.d "M16.247 7.761a6 6 0 0 1 1.744 4.572" ] [], S.path [ SA.d "M19.075 4.933a10 10 0 0 1 2.234 10.72" ] [], S.path [ SA.d "m2 2 20 20" ] [], S.path [ SA.d "M4.925 19.067a10 10 0 0 1 0-14.134" ] [], S.path [ SA.d "M7.753 16.239a6 6 0 0 1 0-8.478" ] [] ]
...
-}
repeatOffIcon : List (S.Attribute msg) -> H.Html msg
repeatOffIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M11.656 6H21l-4-4" ] [], S.path [ SA.d "M17.898 17.898A4 4 0 0 1 17 18H3l4-4" ] [], S.path [ SA.d "m2 2 20 20" ] [], S.path [ SA.d "M21 13v1a4 4 0 0 1-.171 1.159" ] [], S.path [ SA.d "m21 6-4 4" ] [], S.path [ SA.d "M3 11v-1a4 4 0 0 1 3.102-3.898" ] [], S.path [ SA.d "m7 22-4-4" ] [] ]
...
-}
roadIcon : List (S.Attribute msg) -> H.Html msg
roadIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M12 17v4" ] [], S.path [ SA.d "M12 5V3" ] [], S.path [ SA.d "M12 9v3" ] [], S.path [ SA.d "M2.077 18.449A2 2 0 0 0 4 21h16a2 2 0 0 0 1.924-2.55l-4-14A2 2 0 0 0 16 3H8a2 2 0 0 0-1.924 1.45z" ] [] ]
...
rotate3DIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "m15.194 13.707 3.814 1.86-1.86 3.814" ] [], S.path [ SA.d "M16.47214 7.52786 A 5 10 0 1 0 13 21.79796" ] [], S.path [ SA.d "M21.79796 11 A 10 5 0 1 0 19 15.57071" ] [] ]
...
scaleIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M12 3v18" ] [], S.path [ SA.d "m19 8 3 8a5 5 0 0 1-6 0zV7" ] [], S.path [ SA.d "M3 7h1a17 17 0 0 0 8-2 17 17 0 0 0 8 2h1" ] [], S.path [ SA.d "m5 8 3 8a5 5 0 0 1-6 0zV7" ] [], S.path [ SA.d "M7 21h10" ] [] ]
...
schoolIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M14 21v-3a2 2 0 0 0-4 0v3" ] [], S.path [ SA.d "M18 4.933V21" ] [], S.path [ SA.d "m4 6 7.106-3.79a2 2 0 0 1 1.788 0L20 6" ] [], S.path [ SA.d "m6 11-3.52 2.147a1 1 0 0 0-.48.854V19a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-5a1 1 0 0 0-.48-.853L18 11" ] [], S.path [ SA.d "M6 4.933V21" ] [], S.circle [ SA.cx "12", SA.cy "9", SA.r "2" ] [] ]
...
-}
scooterIcon : List (S.Attribute msg) -> H.Html msg
scooterIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M21 4h-3.5l2 11.05" ] [], S.path [ SA.d "M6.95 17h5.142c.523 0 .95-.406 1.063-.916a6.5 6.5 0 0 1 5.345-5.009" ] [], S.circle [ SA.cx "19.5", SA.cy "17.5", SA.r "2.5" ] [], S.circle [ SA.cx "4.5", SA.cy "17.5", SA.r "2.5" ] [] ]
...
-}
searchAlertIcon : List (S.Attribute msg) -> H.Html msg
searchAlertIcon options =
    S.svg (baseOptions ++ options) [ S.circle [ SA.cx "11", SA.cy "11", SA.r "8" ] [], S.path [ SA.d "m21 21-4.3-4.3" ] [], S.path [ SA.d "M11 7v4" ] [], S.path [ SA.d "M11 15h.01" ] [] ]
...
-}
shieldCogIcon : List (S.Attribute msg) -> H.Html msg
shieldCogIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "m10.929 14.467-.383.924" ] [], S.path [ SA.d "M10.929 8.923 10.546 8" ] [], S.path [ SA.d "M13.225 8.923 13.608 8" ] [], S.path [ SA.d "m13.607 15.391-.382-.924" ] [], S.path [ SA.d "m14.849 10.547.923-.383" ] [], S.path [ SA.d "m14.849 12.843.923.383" ] [], S.path [ SA.d "M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z" ] [], S.path [ SA.d "m9.305 10.547-.923-.383" ] [], S.path [ SA.d "m9.305 12.843-.923.383" ] [], S.circle [ SA.cx "12.077", SA.cy "11.695", SA.r "3" ] [] ]
...
-}
shieldCogCornerIcon : List (S.Attribute msg) -> H.Html msg
shieldCogCornerIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M11 22c-3.806-1.45-7-3.966-7-9V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1v4" ] [], S.path [ SA.d "M14.923 16.547 14 16.164" ] [], S.path [ SA.d "m14.923 18.843-.923.383" ] [], S.path [ SA.d "M16.547 14.923 16.164 14" ] [], S.path [ SA.d "m16.547 20.467-.383.924" ] [], S.path [ SA.d "m18.843 14.923.383-.923" ] [], S.path [ SA.d "m19.225 21.391-.382-.924" ] [], S.path [ SA.d "m20.467 16.547.923-.383" ] [], S.path [ SA.d "m20.467 18.843.923.383" ] [], S.circle [ SA.cx "17.695", SA.cy "17.695", SA.r "3" ] [] ]
...
signpostIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M12 13v8" ] [], S.path [ SA.d "M12 3v3" ] [], S.path [ SA.d "M2.354 10.354a1.207 1.207 0 0 1 0-1.708l2.06-2.06A2 2 0 0 1 5.828 6h12.344a2 2 0 0 1 1.414.586l2.06 2.06a1.207 1.207 0 0 1 0 1.708l-2.06 2.06a2 2 0 0 1-1.414.586H5.828a2 2 0 0 1-1.414-.586z" ] [] ]
...
-}
sportShoeIcon : List (S.Attribute msg) -> H.Html msg
sportShoeIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "m15 10.42 4.8-5.07" ] [], S.path [ SA.d "M19 18h3" ] [], S.path [ SA.d "M9.5 22 21.414 9.415A2 2 0 0 0 21.2 6.4l-5.61-4.208A1 1 0 0 0 14 3v2a2 2 0 0 1-1.394 1.906L8.677 8.053A1 1 0 0 0 8 9c-.155 6.393-2.082 9-4 9a2 2 0 0 0 0 4h14" ] [] ]
...
-}
squareDashedTextIcon : List (S.Attribute msg) -> H.Html msg
squareDashedTextIcon options =
...
starOffIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "m10.344 4.688 1.181-2.393a.53.53 0 0 1 .95 0l2.31 4.679a2.12 2.12 0 0 0 1.595 1.16l5.166.756a.53.53 0 0 1 .294.904l-3.237 3.152" ] [], S.path [ SA.d "m17.945 17.945.43 2.505a.53.53 0 0 1-.771.56l-4.618-2.428a2.12 2.12 0 0 0-1.973 0L6.396 21.01a.53.53 0 0 1-.77-.56l.881-5.139a2.12 2.12 0 0 0-.611-1.879L2.16 9.795a.53.53 0 0 1 .294-.906l5.165-.755a8 8 0 0 0 .4-.099" ] [], S.path [ SA.d "m2 2 20 20" ] [] ]
...
-}
stoneIcon : List (S.Attribute msg) -> H.Html msg
stoneIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M11.264 2.205A4 4 0 0 0 6.42 4.211l-4 8a4 4 0 0 0 1.359 5.117l6 4a4 4 0 0 0 4.438 0l6-4a4 4 0 0 0 1.576-4.592l-2-6a4 4 0 0 0-2.53-2.53z" ] [], S.path [ SA.d "M11.99 22 14 12l7.822 3.184" ] [], S.path [ SA.d "M14 12 8.47 2.302" ] [] ]
...
thermometerSunIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M12 2v2" ] [], S.path [ SA.d "M12 8a4 4 0 0 0-1.645 7.647" ] [], S.path [ SA.d "M2 12h2" ] [], S.path [ SA.d "M20 14.54a4 4 0 1 1-4 0V4a2 2 0 0 1 4 0z" ] [], S.path [ SA.d "m4.93 4.93 1.41 1.41" ] [], S.path [ SA.d "m6.34 17.66-1.41 1.41" ] [] ]
...
thumbsDownIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M9 18.12 10 14H4.17a2 2 0 0 1-1.92-2.56l2.33-8A2 2 0 0 1 6.5 2H20a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2h-2.76a2 2 0 0 0-1.79 1.11L12 22a3.13 3.13 0 0 1-3-3.88Z" ] [], S.path [ SA.d "M17 14V2" ] [] ]
...
thumbsUpIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M15 5.88 14 10h5.83a2 2 0 0 1 1.92 2.56l-2.33 8A2 2 0 0 1 17.5 22H4a2 2 0 0 1-2-2v-8a2 2 0 0 1 2-2h2.76a2 2 0 0 0 1.79-1.11L12 2a3.13 3.13 0 0 1 3 3.88Z" ] [], S.path [ SA.d "M7 10v12" ] [] ]
...
ticketsIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "m3.173 8.18 11-5a2 2 0 0 1 2.647.993L18.56 8" ] [], S.path [ SA.d "M6 10V8" ] [], S.path [ SA.d "M6 14v1" ] [], S.path [ SA.d "M6 19v2" ] [], S.rect [ SA.x "2", SA.y "8", SA.width "20", SA.height "13", SA.rx "2" ] [] ]
...
ticketsPlaneIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M10.5 17h1.227a2 2 0 0 0 1.345-.52L18 12" ] [], S.path [ SA.d "m12 13.5 3.794.506" ] [], S.path [ SA.d "m3.173 8.18 11-5a2 2 0 0 1 2.647.993L18.56 8" ] [], S.path [ SA.d "M6 10V8" ] [], S.path [ SA.d "M6 14v1" ] [], S.path [ SA.d "M6 19v2" ] [], S.rect [ SA.x "2", SA.y "8", SA.width "20", SA.height "13", SA.rx "2" ] [] ]
...
-}
timelineIcon : List (S.Attribute msg) -> H.Html msg
timelineIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M4 12h.01" ] [], S.path [ SA.d "M4 16h.01" ] [], S.path [ SA.d "M4 20h.01" ] [], S.path [ SA.d "M4 4h.01" ] [], S.path [ SA.d "M4 8h.01" ] [], S.path [ SA.d "M9.414 13.414a2 2 0 0 0 1.414.586H19a1 1 0 0 0 1-1v-2a1 1 0 0 0-1-1h-8.172a2 2 0 0 0-1.414.586L8 12z" ] [], S.path [ SA.d "M9.414 21.414a2 2 0 0 0 1.414.586H19a1 1 0 0 0 1-1v-2a1 1 0 0 0-1-1h-8.172a2 2 0 0 0-1.414.586L8 20z" ] [], S.path [ SA.d "M9.414 5.414A2 2 0 0 0 10.828 6H19a1 1 0 0 0 1-1V3a1 1 0 0 0-1-1h-8.172a2 2 0 0 0-1.414.586L8 4z" ] [] ]
...
-}
toolboxIcon : List (S.Attribute msg) -> H.Html msg
toolboxIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M16 12v4" ] [], S.path [ SA.d "M16 6a2 2 0 0 1 1.414.586l4 4A2 2 0 0 1 22 12v7a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2v-7a2 2 0 0 1 .586-1.414l4-4A2 2 0 0 1 8 6z" ] [], S.path [ SA.d "M16 6V4a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v2" ] [], S.path [ SA.d "M2 14h20" ] [], S.path [ SA.d "M8 12v4" ] [] ]
...
-}
vanIcon : List (S.Attribute msg) -> H.Html msg
vanIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M13 6v5a1 1 0 0 0 1 1h6.102a1 1 0 0 1 .712.298l.898.91a1 1 0 0 1 .288.702V17a1 1 0 0 1-1 1h-3" ] [], S.path [ SA.d "M5 18H3a1 1 0 0 1-1-1V8a2 2 0 0 1 2-2h12c1.1 0 2.1.8 2.4 1.8l1.176 4.2" ] [], S.path [ SA.d "M9 18h5" ] [], S.circle [ SA.cx "16", SA.cy "18", SA.r "2" ] [], S.circle [ SA.cx "7", SA.cy "18", SA.r "2" ] [] ]
...
wavesIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M2 12q2.5 2 5 0t5 0 5 0 5 0" ] [], S.path [ SA.d "M2 19q2.5 2 5 0t5 0 5 0 5 0" ] [], S.path [ SA.d "M2 5q2.5 2 5 0t5 0 5 0 5 0" ] [] ]
...
-}
wavesArrowDownIcon : List (S.Attribute msg) -> H.Html msg
wavesArrowDownIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M12 10L12 2" ] [], S.path [ SA.d "M16 6L12 10L8 6" ] [], S.path [ SA.d "M2 15C2.6 15.5 3.2 16 4.5 16C7 16 7 14 9.5 14C12.1 14 11.9 16 14.5 16C17 16 17 14 19.5 14C20.8 14 21.4 14.5 22 15" ] [], S.path [ SA.d "M2 21C2.6 21.5 3.2 22 4.5 22C7 22 7 20 9.5 20C12.1 20 11.9 22 14.5 22C17 22 17 20 19.5 20C20.8 20 21.4 20.5 22 21" ] [] ]
...
-}
wavesArrowUpIcon : List (S.Attribute msg) -> H.Html msg
wavesArrowUpIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M12 2v8" ] [], S.path [ SA.d "M2 15c.6.5 1.2 1 2.5 1 2.5 0 2.5-2 5-2 2.6 0 2.4 2 5 2 2.5 0 2.5-2 5-2 1.3 0 1.9.5 2.5 1" ] [], S.path [ SA.d "M2 21c.6.5 1.2 1 2.5 1 2.5 0 2.5-2 5-2 2.6 0 2.4 2 5 2 2.5 0 2.5-2 5-2 1.3 0 1.9.5 2.5 1" ] [], S.path [ SA.d "m8 6 4-4 4 4" ] [] ]
...
-}
wavesHorizontalIcon : List (S.Attribute msg) -> H.Html msg
wavesHorizontalIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M2 12q2.5 2 5 0t5 0 5 0 5 0" ] [], S.path [ SA.d "M2 19q2.5 2 5 0t5 0 5 0 5 0" ] [], S.path [ SA.d "M2 5q2.5 2 5 0t5 0 5 0 5 0" ] [] ]
...
-}
wavesVerticalIcon : List (S.Attribute msg) -> H.Html msg
wavesVerticalIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M12 2q2 2.5 0 5t0 5 0 5 0 5" ] [], S.path [ SA.d "M19 2q2 2.5 0 5t0 5 0 5 0 5" ] [], S.path [ SA.d "M5 2q2 2.5 0 5t0 5 0 5 0 5" ] [] ]
...
waypointsIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "m10.586 5.414-5.172 5.172" ] [], S.path [ SA.d "m18.586 13.414-5.172 5.172" ] [], S.path [ SA.d "M6 12h12" ] [], S.circle [ SA.cx "12", SA.cy "20", SA.r "2" ] [], S.circle [ SA.cx "12", SA.cy "4", SA.r "2" ] [], S.circle [ SA.cx "20", SA.cy "12", SA.r "2" ] [], S.circle [ SA.cx "4", SA.cy "12", SA.r "2" ] [] ]
...
-}
weightTildeIcon : List (S.Attribute msg) -> H.Html msg
weightTildeIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M6.5 8a2 2 0 0 0-1.906 1.46L2.1 18.5A2 2 0 0 0 4 21h16a2 2 0 0 0 1.925-2.54L19.4 9.5A2 2 0 0 0 17.48 8z" ] [], S.path [ SA.d "M7.999 15a2.5 2.5 0 0 1 4 0 2.5 2.5 0 0 0 4 0" ] [], S.circle [ SA.cx "12", SA.cy "5", SA.r "3" ] [] ]
