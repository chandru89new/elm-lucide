...
ticketsPlaneIcon options =
    S.svg (baseOptions ++ options) [ S.path [ SA.d "M10.5 17h1.227a2 2 0 0 0 1.345-.52L18 12" ] [], S.path [ SA.d "m12 13.5 3.75.5" ] [], S.path [ SA.d "m3.173 8.18 11-5a2 2 0 0 1 2.647.993L18.56 8" ] [], S.path [ SA.d "M6 10V8" ] [], S.path [ SA.d "M6 14v1" ] [], S.path [ SA.d "M6 19v2" ] [], S.rect [ SA.x "2", SA.y "8", SA.width "20", SA.height "13", SA.rx "2" ] [] ]
